...
<!-- ## Outline -->
<!-- - What do I want students to take away from this? -->
<!--     - Evolution is awesome -->
<!--     - Virus follow evolutionary processes fast enough for us to observe -->
<!--     - Why variants exist? -->
<!--     - Why we're interested in predicting evolution? -->
<!--     - Evolution and transmission are intimately related -->
<!--     - Mathematics and statistics are good tools for understanding populations -->
<!-- - What is needed to establish this? -->
<!--     - Evolution and transmission occur on same timescale -->
<!--     - Mutation can lead to phenotypic differences between viruses -> affects spread -->
<!--     - How do we visualize evolution? -->
<!--     - How do we quantify this spread? -->
<!--     - How can we do both at once? -->
<!--         - MLR -->
<!--         - Combining in knowledge from epidemic models -->
